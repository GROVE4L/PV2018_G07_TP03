/*
Punto 08: Desarrolle una aplicación que permita registrar un conjunto de Manual. Por cada libro
...
public class Manual {
    ...
    public Manual(long isbn, String titulo, String autor, double precio) {
        this.isbn = isbn;
        this.titulo = titulo;
        this.autor = autor;
        this.precio = precio;
